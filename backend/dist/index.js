...
import { createTalkingAvatar } from './services/didService.js';
import { initializePineconeIndex } from './services/knowledgeService.js';
...
io.on('connection', (socket) => {
    ...
    socket.on('user-message', async (message) => {
        ...
        try {
            ...
            let aiResponse;
            try {
                const isComplexQuery = text.length > 50 ||
            ...
            if (avatar) {
                try {
                    ...
                    const avatarResult = await createTalkingAvatar(aiResponse, null, 'professional');
