import { createTalkingAvatar, getTalkStatus, createCombinedAnimation } from '../services/didService.js';
/**
...
export const generateAvatar = async (req, res) => {
    try {
        ...
        const result = await createTalkingAvatar(text || null, voice_url || null, avatar_type || 'professional');
 ...
 */
export const generateCombinedAvatar = async (req, res) => {
    try {
