import { textToSpeech, listVoices, getVoice } from '../services/elevenLabsService.js';
/**
 ...
 */
export const getAvailableVoices = async (_req, res) => {
    try {
 ...
 * Get voice details
 */
export const getVoiceDetails = async (req, res) => {
    try {
